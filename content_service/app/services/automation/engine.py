...
from app.services.automation.tools import TavilyTool, GeminiTool, EmailTool, UnsplashTool
from app.services.automation.prompts import (
...
class ArticleAutomationEngine:
    ...
    async def process_single_topic(self, topic_info):
        ...
        try:
            ...
            # Clear any hallucinated image URL generated by the LLM
            ...
            if "content_blocks" in final_article_data:
                for block in final_article_data["content_blocks"]:
                    if block.get("type") == "image":
                        # Clear hallucinated LLM image URLs
                        block["content"] = ""
